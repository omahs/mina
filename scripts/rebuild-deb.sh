...
cp ./default/src/test/archive/patch_archive_test.exe "${BUILDDIR}/usr/local/bin/mina-patch-archive-test"
cp ./default/src/dump_blocks/dump_blocks.exe "${BUILDDIR}/usr/local/bin/mina-dump-blocks"
